...
# Optional: One-time index creation (run this once)
# create_parquet_index('authors.parquet', 'authors_index.parquet')
# create_parquet_index('author_details.parquet', 'author_details_index.parquet')

# Then use indexed reading:
# authors_data_df = read_parquet_with_index('authors.parquet', 'authors_index.parquet', authors_cols_to_load, matched_ids_set)