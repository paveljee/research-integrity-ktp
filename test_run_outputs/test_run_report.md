...
- Searched 10 names: 0 found in existing graph, 9 potential API lookups performed.
...
- Master RDF Graph now contains 163 triples.
...
- Excel Reading: 0.1730 seconds
- OpenAlex API Interaction and Graph Lookup: 3.9360 seconds
- Authors Parquet Reading: 0.0040 seconds
- Author Details Parquet Reading: 0.0030 seconds
- Data Collation: 0.0051 seconds
- Collated Parquet Saving: 0.0073 seconds
- Collated CSV Saving: 0.0000 seconds
- RDF Generation and Serialization: 0.0412 seconds
- **Overall Script**: 4.2176 seconds
